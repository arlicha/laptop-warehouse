...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.u1jyq.mongodb.net/?retryWrites=true&w=majority`;
...
app.get("/", (req, res) => {
  res.send("Running server site liccha form bangladesh");
});
